...
class LensHandler {
    ...
    var lookupArrayDistances = [Double]()
    var lookupArraySteps = [Int]()
    ...
    init (lensID: Int) {
        if lensID == 0 {
            ...
            lookupArrayDistances = [172.0,179.0,185.0,192.0,201.0,208.0,217.0,225.0,
            ...
            lookupArraySteps =     [0,  30, 60, 90, 120,150,180,210,
            ...
            lookupArrayDistances =  [193.0,198.0,   203.0,    209.0,    216.0,    224.0,    232.0,    241.0,    250.0,    261.0,    273.0,    285.0,    298.0,    314.0,    330.0,    347.0]
            lookupArraySteps =      [0,     100,    200,    300,    400,    500,    600,    700,    800,    900,    1000,   1100,   1200,   1300,   1400,   1491]
    ...
    func getLensStepsFromDistance(focusDistance: Double) -> Int {
        ...
        // arrg cludgy but gotta shoot today
